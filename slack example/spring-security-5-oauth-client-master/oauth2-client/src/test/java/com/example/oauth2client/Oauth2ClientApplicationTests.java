...
public class Oauth2ClientApplicationTests {
	...
	public void oauth() throws Exception {
		...
		Mockito.when(this.restTemplate.exchange(
				...
				Mockito.any(),
				Mockito.any(PrincipalDetails.class.getClass())))
				.thenReturn(ResponseEntity.ok(new com.example.oauth2client.PrincipalDetails("joe")));
	...
	private class PrincipalDetails {
	}
}
